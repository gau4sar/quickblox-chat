...
import com.augmentedera.kotlin.async.BaseAsyncTask
import com.augmentedera.kotlin.ui.adapter.DialogsAdapter
import com.augmentedera.kotlin.utils.*
...
import com.augmentedera.kotlin.utils.qb.QbChatDialogMessageListenerImpl
import com.augmentedera.kotlin.utils.qb.QbDialogHolder
import com.augmentedera.kotlin.utils.qb.VerboseQbChatConnectionListener
import com.augmentedera.kotlin.utils.qb.callback.QBPushSubscribeListenerImpl
import com.augmentedera.kotlin.utils.qb.callback.QbEntityCallbackImpl
                ...
                ChatHelper.loginToChat(currentUser,
                        object : QBEntityCallback<Void> {
                            override fun onSuccess(p0: Void?, p1: Bundle?) {
                                hideProgressDialog()
                                ChatActivity.startForResult(this@DialogsActivity,
                                    REQUEST_DIALOG_ID_FOR_UPDATE,
                                    selectedDialog)
                            }
