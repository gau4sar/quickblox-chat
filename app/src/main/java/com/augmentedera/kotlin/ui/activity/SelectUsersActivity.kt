...
import com.augmentedera.kotlin.ui.adapter.CheckboxUsersAdapter
import com.augmentedera.kotlin.ui.adapter.ScrollViewWithMaxHeight
                ...
                if (::usersAdapter.isInitialized) {
                    if (usersAdapter.selectedUsers.size < MINIMUM_CHAT_OCCUPANTS_SIZE) {
                        ...
                        if (qbChatDialog == null && usersAdapter.selectedUsers.size >= PRIVATE_CHAT_OCCUPANTS_SIZE) {
                            NewGroupActivity.startForResult(this@SelectUsersActivity,
                                REQUEST_DIALOG_NAME)
                        } else {
