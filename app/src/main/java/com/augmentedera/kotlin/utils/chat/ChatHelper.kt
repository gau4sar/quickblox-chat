package com.augmentedera.kotlin.utils.chat

import android.os.AsyncTask
import android.os.Bundle
import android.util.Log
import com.augmentedera.kotlin.*
...
import com.augmentedera.kotlin.utils.qb.callback.QbEntityCallbackTwoTypeWrapper
import com.augmentedera.kotlin.utils.qb.callback.QbEntityCallbackWrapper
...
object ChatHelper {
    ...
    fun deleteDialog(qbDialog: QBChatDialog, callback: QBEntityCallback<Void>) {
        if (qbDialog.type == QBDialogType.PUBLIC_GROUP) {
            ...
            QBRestChatService.deleteDialog(qbDialog.dialogId, false).performAsync(
